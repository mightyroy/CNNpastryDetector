...
class YOLO_TF:
	...
	filewrite_txt = False
	disp_console = True
	weights_file = 'weights/weightsTinyRoy.ckpt'
	alpha = 0.1
	threshold = 0.2
	iou_threshold = 0.5
	num_class = 20
	...
	def build_networks(self):
		...
		#skip dropout_18
		self.fc_19 = self.fc_layer(19,self.fc_17,686,flat=False,linear=True)
		...
		self.saver = tf.train.Saver(["Variable"])
		...
		# 	vname = v.name
		# 	l[vname[0:-2]] = v
			# if vname == "Variable_22:0":
			# 	self.sess.run(v.assign(tf.truncated_normal([4096,686], stddev=0.1)))
			# 	print 'v alala', v.eval()


			# if vname == "Variable_23:0":
			# 	self.sess.run(v.assign(tf.constant(0.1, shape=[686,])))
			# 	print 'v alala', v.eval()
			#print v.name
			#print v.get_shape()
		...
		# del l["Variable_23"] 
		# print l
		# saver2 = tf.train.Saver(l)
		# saver2.save(self.sess, "./weights/weightsTinyRoy.ckpt")




		with tf.variable_scope("19_fc", reuse=True):
   			#v1 = tf.get_variable("Variable_23")
   			print tf.get_variable_scope()
		#k = tf.get_variable('Variable_23', (1470,))
		#print k.name
		#print k.get_shape()
		#print self.sess.run(k)
		#k.eval()


		#input_shape = self.fc_17.get_shape().as_list()
		#v = tf.get_variable('Variable_22:0', [input_shape[1],1470])
		#print v
		#print self.sess.run()
